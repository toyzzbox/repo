...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Sağ Taraf - Görsel */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-400 via-pink-400 to-yellow-300 items-center justify-center p-12 relative overflow-hidden">
